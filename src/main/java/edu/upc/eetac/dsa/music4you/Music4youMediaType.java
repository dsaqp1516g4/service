...
public interface Music4youMediaType {
    ...
    String MUSIC4YOU_MESSAGE_COLLECTION = "application/vnd.dsa.apartmentshare.message.collection+json";
    String MUSIC4YOU_MESSAGE = "application/vnd.dsa.apartmentshare.message+json";
    String MUSIC4YOU_PLAYLIST_COLLECTION_GENRE = "application/vnd.dsa.music4you.playlist.collection.genre+json";
    String MUSIC4YOU_PLAYLIST_COLLECTION_ARTIST = "application/vnd.dsa.music4you.playlist.artist+json";
